-- Role-Based Access Control Setup for ISKA RMS
-- Run this in your Supabase SQL Editor

-- 1. First, update the user_role enum to include all our roles
ALTER TYPE user_role ADD VALUE IF NOT EXISTS 'super_admin';
ALTER TYPE user_role ADD VALUE IF NOT EXISTS 'admin';
ALTER TYPE user_role ADD VALUE IF NOT EXISTS 'salesperson';
ALTER TYPE user_role ADD VALUE IF NOT EXISTS 'reservationist';
...
-- 4. Create module_access_config table
...
-- 9. Update existing admin user to super_admin role
UPDATE public.users 
...
-- 11. Insert default module access config
